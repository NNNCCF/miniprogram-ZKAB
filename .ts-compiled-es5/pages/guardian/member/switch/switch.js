...
Page({
    ...
    loadMembers: function () {
        return __awaiter(this, void 0, void 0, function () {
            var members, savedId, currentId, e_1;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        members = (_c.sent()) || [];
                        savedId = wx.getStorageSync('currentMemberId');
                        currentId = savedId || ((_b = (_a = members[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null);
                        if (!savedId && currentId)
                            wx.setStorageSync('currentMemberId', currentId);
                        this.setData({ members: members, currentId: currentId });
                        return [3 /*break*/, 3];
                    case 2:
                        e_1 = _c.sent();
                        wx.showToast({ title: e_1.message || '加载失败', icon: 'none' });
                        return [3 /*break*/, 3];
    ...
    switchMember: function (e) {
        ...
        if (String(memberId) === String(this.data.currentId))
            return;
