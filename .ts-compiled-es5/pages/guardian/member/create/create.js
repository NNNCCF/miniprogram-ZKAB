...
Page({
    ...
    onSubmit: function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, form, loading, birthYear, birthday, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.data, form = _a.form, loading = _a.loading;
                        if (loading)
                            return [2 /*return*/];
                        ...
                        birthYear = new Date().getFullYear() - parseInt(form.age);
                        birthday = "".concat(birthYear, "-01-01");
                        this.setData({ loading: true });
                        wx.showLoading({ title: '提交中...' });
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, (0, api_1.createMember)({
                                name: form.name.trim(),
                    ...
                    case 3:
                        e_1 = _b.sent();
                        wx.hideLoading();
                        wx.showToast({ title: e_1.message || '提交失败', icon: 'none' });
                        return [3 /*break*/, 5];
                    case 4:
